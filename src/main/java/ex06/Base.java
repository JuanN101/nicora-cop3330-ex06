...
public class Base {
    public static void main(String[] args) {
        ...
        int r = Integer.parseInt(retire);
        Date d = new Date();
        int year = d.getYear()+1900;

        System.out.println("You have " + (r - a) + " years left until you can retire.");
        System.out.println("It's " + year + ", so you can retire in " + (year + (r - a)) + ".");
